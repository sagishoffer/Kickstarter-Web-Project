...
<head>
	...
	<script src="js/editProjectFunctions.js"></script>
	<script>
	...
	<div class="container" style="margin-top: 80px;">
		...
		<div class="row">
			...
			<div class="col-md-10 personal-info text-center">
				...
				<form class="form-horizontal" id="projectEditForm" action="php/updateProject.php" method="post" enctype="multipart/form-data">

					<!-- Project id -->
					<input type="hidden" name="projectId" value="<?php echo $_POST["projectId"]; ?>"/>

					<!-- Image -->
					<input type="hidden" name="projectPic" value="<?php echo $_POST["projectPic"]; ?>"/>

					<!-- title -->
					<div class="form-group">
						<label class="col-lg-3 control-label">Project name:</label>
						<div class="col-lg-8">
							<input id="titleInput" name="titleInput" class="form-control" type="text" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input id="dateInput" name="dateInput" class="form-control" type="date" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input id="goalInput" name="goalInput" class="form-control" type="number" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-lg-8">
							<input id="videoInput" name="videoInput" class="form-control" type="text"  />
						</div>
					</div>
